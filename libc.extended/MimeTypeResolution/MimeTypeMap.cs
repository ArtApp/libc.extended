...
namespace libc.extended.MimeTypeResolution
{
    public static class MimeTypeMap
    {
        ...
        private static readonly string[] officeExt =
        {
            ".csv",
            ".xls",
            ".xlsx",
        ...
        private static readonly Dictionary<FileCategories, string[]> dic =
            new Dictionary<FileCategories, string[]>
            {
                {
                    FileCategories.Archive, archiveExt
                },
                {
                    FileCategories.Audio, audioExt
                },
                {
                    FileCategories.Image, imageExt
                },
                {
                    FileCategories.Office, officeExt
                },
                {
                    FileCategories.Video, videoExt
                }
            };
        ...
        public static FileCategories GetFileCategory(string extension)
        {
            if (extension == null) throw new ArgumentNullException(nameof(extension));
            if (!extension.StartsWith(".")) extension = "." + extension;

            foreach (var key in dic.Keys)
                if (dic[key].Contains(extension, StringComparer.OrdinalIgnoreCase))
                    return key;
